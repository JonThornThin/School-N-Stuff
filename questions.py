...
mm=int(input("what was the month of the year? (e.g. March is 3) "))
if mm=="1":
    mm=mm+12
if mm=="1":
    mm=mm+12
c=int(input("what was the century? (e.g. 2025 is the 21st century) "))
y=int(input("what was the year of the century? (e.g. 2025 is the 25th year) "))
A=13*mm
B=A/5
ww=dd+B+y+y/4+c/4-2*c
w=ww%7
print(w)
